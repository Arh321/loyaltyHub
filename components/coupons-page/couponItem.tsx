  ...
  return (
    ...
    >
      ...
      >
        ...
        {copySuccess && (
          <span className="absolute  whitespace-nowrap rounded left-0 -bottom-8 w-max px-4 py-1 font-Medium text-Highlighter bg-[#48BB78] mx-auto font-regular text-highliter animate-fadeIn flex justify-center items-center">
            {copySuccess}
          </span>
        )}
      </button>
