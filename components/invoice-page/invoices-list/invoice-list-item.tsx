  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between ">
        ...
        <span className="px-[10px] min-w-[123px] py-1 flex items-start justify-center gap-1 bg-Focus rounded-[50px] text-Highlighter">
      ...
      <div className="w-full flex items-center justify-between ">
        ...
        <span className="text-Secondary font-Regular">۱۴۰۳/۰۲/۱۵ - ۱۶:۳۲</span>
      </div>
